...
#ssh $REMOTE_USER@$SERVER_IP "mkdir -p /var/objective8/config"
#scp objective8_env $REMOTE_USER@$SERVER_IP:/var/objective8/config/objective8_config 
scp $TAR $REMOTE_USER@$SERVER_IP:/var/objective8/$TAR
